...
$_['text_wishlist'] = '%s';
$_['text_login']    = 'Необхідно увійти до <a href="%s">особистого кабінету</a> або <a href="%s">створити обліковий запис</a> для того, щоб зберегти товар <a href="%s">%s</a> у <a href="%s">списку бажаного</a>';
$_['text_success']  = 'Товар <a href="%s">%s</a> був доданий у <a href="%s">список бажань</a>';
$_['text_remove']   = 'Обрані товари оновлені';
