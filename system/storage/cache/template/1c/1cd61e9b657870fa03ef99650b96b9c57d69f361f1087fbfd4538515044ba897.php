...
class __TwigTemplate_10e5db27522c67eeeefa0098346ea020a912c6cd487db38b8159124c9dceed99 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t<div class=\"product-page__icon-title quote-block__title flex-row\">
                            ";
        // line 298
        echo twig_call_macro($macros["macros"], "macro_svg", ["warning", ""], 298, $context, $this->getSourceContext());
        echo "
...
\t\t\t\t\t<div class=\"quote-block__content d-flex\">
                        ";
        // line 305
        echo twig_call_macro($macros["macros"], "macro_svg", ["quote", "quote-block__icon"], 305, $context, $this->getSourceContext());
        echo "
...
<template id=\"photoUploadTemplate\">
    <div class=\"photo-upload__file rel o-hid\">
        ...
        <button class=\"photo-upload__delete btn flex-center icon abs\" type=\"button\">
            ";
        // line 318
        echo twig_call_macro($macros["macros"], "macro_svg", ["close", ""], 318, $context, $this->getSourceContext());
        echo "
        </button>
    </div>
</template>
