...
class __TwigTemplate_b7dd913837fc727c61daaf3383ff6ce544b29153bf0e4053d8ae90e7336b3252 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<main>
    <div class=\"page-title border--end\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["breadcrumb"]) {
            ...
            echo twig_get_attribute($this->env, $this->source, $context["breadcrumb"], "href", [], "any", false, false, false, 310);
            echo "\">";
            echo twig_get_attribute($this->env, $this->source, $context["breadcrumb"], "text", [], "any", false, false, false, 310);
            echo "</a>
                    ";
        }
        $_parent = $context['_parent'];
    ...
    <section class=\"sign-form\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["customer_group"]) {
            // line 323
            echo "                      ";
            if ((twig_get_attribute($this->env, $this->source, $context["customer_group"], "customer_group_id", [], "any", false, false, false, 323) == ($context["customer_group_id"] ?? null))) {
                // line 324
                echo "                      <div class=\"radio\">
                        <label>
                          <input type=\"radio\" name=\"customer_group_id\" value=\"";
                ...
                echo "\" checked=\"checked\" />
                          ";
                // line 327
                echo twig_get_attribute($this->env, $this->source, $context["customer_group"], "name", [], "any", false, false, false, 327);
                echo "</label>
                      </div>
                      ";
            } else {
                ...
                echo "                      <div class=\"radio\">
                        <label>
                          <input type=\"radio\" name=\"customer_group_id\" value=\"";
                // line 332
                echo twig_get_attribute($this->env, $this->source, $context["customer_group"], "customer_group_id", [], "any", false, false, false, 332);
                echo "\" />
                          ";
                // line 333
        ...
        echo "\" placeholder=\"";
        echo ($context["entry_firstname"] ?? null);
        echo "\" id=\"input-firstname\" required />
        ...
        echo "\" placeholder=\"";
        echo ($context["entry_telephone"] ?? null);
        echo "\" id=\"input-telephone\" required />
                        <div class=\"custom-input__error d-none\">";
        // line 345
        echo ($context["error_required_field"] ?? null);
        echo "</div>
        ...
        <div class=\"container sign-form__container\">
            ...
            <form class=\"sign-form__form mx\" action=\"{{ action }}\" method=\"post\" enctype=\"multipart/form-data\">
              <div class=\"form-group required\" style=\"display: {% if customer_groups|length > 1 %} block {% else %} none {% endif %};\">
                ...
                <div class=\"sign-form__fields flex-col\">
                    <div class=\"sign-form__field custom-input\">
                        <input class=\"custom-input__input\" type=\"text\" name=\"firstname\" value=\"{{ firstname }}\" placeholder=\"{{ entry_firstname }}\" id=\"input-firstname\" required />
                        <div class=\"custom-input__error d-none\">{{ error_required_field }}</div>
                    </div>
                    <div class=\"sign-form__field custom-input valid\">
                        <input class=\"custom-input__input\" type=\"tel\" name=\"telephone\" value=\"{{ telephone }}\" placeholder=\"{{ entry_telephone }}\" id=\"input-telephone\" required />
                        <div class=\"custom-input__error d-none\">{{ error_required_field }}</div>
                    </div>
                    <div class=\"sign-form__field custom-input invalid\">
