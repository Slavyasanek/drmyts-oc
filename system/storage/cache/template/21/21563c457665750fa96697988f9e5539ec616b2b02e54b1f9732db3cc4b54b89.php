...
class __TwigTemplate_d3dfbbcf5211ad83de03d48b0fec28338098ac8dddffd7b7ec1832a01597c7c8 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<main>
    ...
    <section class=\"sign-form\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["customer_group"]) {
            // line 330
            echo "                          ";
            if ((twig_get_attribute($this->env, $this->source, $context["customer_group"], "customer_group_id", [], "any", false, false, false, 330) == ($context["customer_group_id"] ?? null))) {
                // line 331
                echo "
                ...
                // line 334
                echo twig_get_attribute($this->env, $this->source, $context["customer_group"], "customer_group_id", [], "any", false, false, false, 334);
                ...
                echo "\">";
                echo twig_get_attribute($this->env, $this->source, $context["customer_group"], "name", [], "any", false, false, false, 336);
                echo "</label>
                            </div>
                ...
                echo "\">";
                echo twig_get_attribute($this->env, $this->source, $context["customer_group"], "name", [], "any", false, false, false, 345);
                echo "</label>
                            </div>
        ...
        echo "\" id=\"input-password\" />
                        <button class=\"btn flex-center custom-input__icon abs\" type=\"button\">
                            ";
        // line 382
        echo twig_call_macro($macros["macros"], "macro_svg", ["eye", "anim"], 382, $context, $this->getSourceContext());
        echo "
                        </button>
                        ";
        // line 384
        ...
        echo "\" id=\"input-confirm\" />
                        <button class=\"btn flex-center custom-input__icon abs\" type=\"button\">
                            ";
        // line 391
        echo twig_call_macro($macros["macros"], "macro_svg", ["eye", "anim"], 391, $context, $this->getSourceContext());
        echo "
                        </button>
                        ";
        // line 393
