...
class __TwigTemplate_5809c71722def803696a1eaa08a2e5c2ccfcbe9607e4cd218027945de57fdd0d extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t\t<button class=\"btn btn--theme btn--theme_dark text--upp btn--size_M flex-row photo-upload__btn\" type=\"button\">
                                                ";
            // line 271
            echo twig_call_macro($macros["macros"], "macro_svg", ["plus", ""], 271, $context, $this->getSourceContext());
            echo "
\t\t\t\t\t\t\t\t\t\t\t\t<span>
\t\t\t\t\t\t\t\t\t\t\t\t\tДодати фото</span>
\t\t\t\t\t\t\t\t\t\t\t</button>
...
\t\t\t\t\t\t\t\t\t\t<button class=\"btn btn--theme btn--theme_accent btn--size_M text--upp w-full review-form__btn\" type=\"submit\"  id=\"button-review\" data-loading-text=\"";
            // line 280
            echo ($context["text_loading"] ?? null);
            echo "\">Опублікувати відгук</button>
...
\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t<div class=\"review-form__footing flex-col\">
\t\t\t\t\t\t\t\t\t\t<button class=\"btn btn--theme btn--theme_accent btn--size_M text--upp w-full review-form__btn\" type=\"submit\"  id=\"button-review\" data-loading-text=\"{{ text_loading }}\">Опублікувати відгук</button>
