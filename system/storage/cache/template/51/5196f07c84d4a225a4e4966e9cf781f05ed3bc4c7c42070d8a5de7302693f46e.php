...
class __TwigTemplate_82f87778f42ecad4e247aac4b7e7e0e196d9c1e64f9394d415bec8be5583e57e extends \Twig\Template
{
    private $source;
    private $macros = [];
                    ...
                    <div class=\"account-details__col flex-col\">
                        <div class=\"account-details__field custom-input custom-input--type_password rel\">
                            ...
                            <button class=\"btn flex-center custom-input__icon abs\" type=\"button\">
                                ";
        // line 315
        echo twig_call_macro($macros["macros"], "macro_svg", ["eye", "anim"], 315, $context, $this->getSourceContext());
        echo "
                            </button>
                        ...
                        <div class=\"account-details__field custom-input custom-input--type_password rel\">
                            ...
                            <button class=\"btn flex-center custom-input__icon abs\" type=\"button\">
                                ";
        // line 323
        echo twig_call_macro($macros["macros"], "macro_svg", ["eye", "anim"], 323, $context, $this->getSourceContext());
        echo "
                            </button>
                            <div class=\"custom-input__error d-none\">Поле обов'язкове до заповнення</div>
                        </div>
                        <div class=\"account-details__field custom-input custom-input--type_password rel\">
                            ...
                            <button class=\"btn flex-center custom-input__icon abs\" type=\"button\">
                                ";
        // line 331
        echo twig_call_macro($macros["macros"], "macro_svg", ["eye", "anim"], 331, $context, $this->getSourceContext());
        echo "
                            </button>
                            <div class=\"custom-input__error d-none\">Поле обов'язкове до заповнення</div>
                        </div>
    ...
    <div id=\"content\" class=\"{{ class }}\">{{ content_top }}
      ...
      <form action=\"{{ action }}\" method=\"post\" enctype=\"multipart/form-data\" class=\"form-horizontal\">
        <fieldset>
          ...
          <div class=\"form-group{% if custom_field %} {% endif %} custom-field\" data-sort=\"{{ custom_field.sort_order }}\">
