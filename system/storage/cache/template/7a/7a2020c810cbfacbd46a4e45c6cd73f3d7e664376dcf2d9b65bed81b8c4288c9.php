...
class __TwigTemplate_c6b8b729dcd2ec6291525d28b7e97e2e3af9fe1764a596e72a404ddc376f5ad5 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t\t<button class=\"btn btn--theme btn--theme_dark text--upp btn--size_M flex-row photo-upload__btn\" type=\"button\">
                                                ";
            // line 270
            echo twig_call_macro($macros["macros"], "macro_svg", ["plus", ""], 270, $context, $this->getSourceContext());
            echo "
\t\t\t\t\t\t\t\t\t\t\t\t<span>
\t\t\t\t\t\t\t\t\t\t\t\t\tДодати фото</span>
\t\t\t\t\t\t\t\t\t\t\t</button>
...
\t\t\t\t\t\t<div class=\"product-page__icon-title quote-block__title flex-row\">
                            ";
        // line 293
        echo twig_call_macro($macros["macros"], "macro_svg", ["warning", ""], 293, $context, $this->getSourceContext());
        echo "
...
\t\t\t\t\t<div class=\"quote-block__content d-flex\">
                        ";
        // line 300
        echo twig_call_macro($macros["macros"], "macro_svg", ["quote", "quote-block__icon"], 300, $context, $this->getSourceContext());
        echo "
...
\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t<div class=\"review-form__footing flex-col\">
\t\t\t\t\t\t\t\t\t\t<button class=\"btn btn--theme btn--theme_accent btn--size_M text--upp w-full review-form__btn\" type=\"submit\"  id=\"button-review\" data-loading-text=\"{{ text_loading }}\">{{ button_continue }}</button>
\t\t\t\t\t\t\t\t\t\t<button class=\"btn text--upp btn--size_M review-form__close\" type=\"button\">Закрити</button>
\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t</form>
