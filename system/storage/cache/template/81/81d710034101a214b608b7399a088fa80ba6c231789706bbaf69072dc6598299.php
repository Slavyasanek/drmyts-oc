...
class __TwigTemplate_2488aa3dac4ccfd76e9a6750cfc01f2608613ad1d99e41ba44ce2f2e68c5add6 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t";
        // line 137
        echo twig_call_macro($macros["macros"], "macro_svg", ["add-to-cart", ""], 137, $context, $this->getSourceContext());
        echo "
\t\t\t\t\t\t<span>";
        // line 138
...
\t\t\t\t\t\t";
        // line 142
        echo twig_call_macro($macros["macros"], "macro_svg", ["fast-buy", ""], 142, $context, $this->getSourceContext());
        echo "
...
\t\t\t\t\t\t";
        // line 150
        echo twig_call_macro($macros["macros"], "macro_svg", ["heart", ""], 150, $context, $this->getSourceContext());
        echo "
...
\t\t\t\t\t\t";
        // line 155
        echo twig_call_macro($macros["macros"], "macro_svg", ["need-help", ""], 155, $context, $this->getSourceContext());
        echo "
...
\t\t\t\t\t\t\t<div class=\"icon icon--arrow accordion__icon\">
                                ";
        // line 166
        echo twig_call_macro($macros["macros"], "macro_svg", ["arrow-down", ""], 166, $context, $this->getSourceContext());
        echo "
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t\t";
        // line 177
        echo twig_call_macro($macros["macros"], "macro_svg", ["arrow-down", ""], 177, $context, $this->getSourceContext());
        echo "
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t</div>
\t\t\t\t\t\t<div class=\"accordion__content\">
...
\t\t\t\t\t\t\t\t";
        // line 188
        echo twig_call_macro($macros["macros"], "macro_svg", ["arrow-down", ""], 188, $context, $this->getSourceContext());
        echo "
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t</div>
\t\t\t\t\t\t<div class=\"accordion__content\">
...
\t\t\t\t\t\t\t\t";
        // line 199
        echo twig_call_macro($macros["macros"], "macro_svg", ["arrow-down", ""], 199, $context, $this->getSourceContext());
        echo "
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t</div>
\t\t\t\t\t\t<div class=\"accordion__content\">
...
\t\t\t\t\t\t\t\t";
        // line 210
        echo twig_call_macro($macros["macros"], "macro_svg", ["arrow-down", ""], 210, $context, $this->getSourceContext());
        echo "
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t</div>
\t\t\t\t\t\t<div class=\"accordion__content\">
...
\t\t\t\t\t\t\t\t<div class=\"product-rating product-page__rating flex-row\">
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
                ...
                if ((($context["rating"] ?? null) < $context["i"])) {
                    // line 228
                    echo "                                            ";
                    echo twig_call_macro($macros["macros"], "macro_svg", ["empty-star", "product-rating__star--empty"], 228, $context, $this->getSourceContext());
                    echo "
                                        ";
                } else {
                    // line 230
                    echo "                                            ";
                    echo twig_call_macro($macros["macros"], "macro_svg", ["full-star", "product-rating__star"], 230, $context, $this->getSourceContext());
                    echo "
                                        ";
                }
                // line 232
...
\t\t\t\t\t\t\t\t";
            // line 236
            echo twig_call_macro($macros["macros"], "macro_svg", ["arrow-down", ""], 236, $context, $this->getSourceContext());
            echo "
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t\t<button class=\"btn btn--theme btn--size_M btn--theme_accent text--upp flex-row product-page__icon-title product-reviews__btn j-center\" type=\"button\">
                                    ";
                // line 244
                echo twig_call_macro($macros["macros"], "macro_svg", ["leave-review", ""], 244, $context, $this->getSourceContext());
                echo "
\t\t\t\t\t\t\t\t\t<span>";
                // line 245
...
\t\t\t\t\t\t\t\t\t\t\t<input type=\"hidden\" name=\"rating\" id=\"review-rating\" required>
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
                    // line 253
                    echo "                                                ";
                    echo twig_call_macro($macros["macros"], "macro_ratingStar", [$context["i"]], 253, $context, $this->getSourceContext());
                    echo "
                                            ";
                }
                $_parent = $context['_parent'];
...
\t\t\t\t\t\t\t\t\t\t\t<button class=\"btn btn--theme btn--theme_dark text--upp btn--size_M flex-row photo-upload__btn\" type=\"button\">
                                                ";
                // line 274
                echo twig_call_macro($macros["macros"], "macro_svg", ["plus", ""], 274, $context, $this->getSourceContext());
                echo "
\t\t\t\t\t\t\t\t\t\t\t\t<span>";
                // line 275
...
\t\t\t\t\t\t<div class=\"product-page__icon-title quote-block__title flex-row\">
                            ";
        // line 300
        echo twig_call_macro($macros["macros"], "macro_svg", ["warning", ""], 300, $context, $this->getSourceContext());
        echo "
...
\t\t\t\t\t<div class=\"quote-block__content d-flex\">
                        ";
        // line 307
        echo twig_call_macro($macros["macros"], "macro_svg", ["quote", "quote-block__icon"], 307, $context, $this->getSourceContext());
        echo "
...
<template id=\"photoUploadTemplate\">
    <div class=\"photo-upload__file rel o-hid\">
        ...
        <button class=\"photo-upload__delete btn flex-center icon abs\" type=\"button\">
            ";
        // line 320
        echo twig_call_macro($macros["macros"], "macro_svg", ["close", ""], 320, $context, $this->getSourceContext());
        echo "
        </button>
    </div>
</template>
...
";
    ...
    {
        return array (  836 => 500,  795 => 462,  788 => 458,  647 => 320,  631 => 307,  621 => 300,  614 => 295,  609 => 292,  603 => 290,  593 => 283,  587 => 282,  580 => 278,  574 => 275,  570 => 274,  562 => 269,  556 => 266,  546 => 263,  539 => 259,  533 => 255,  524 => 253,  520 => 252,  514 => 249,  507 => 245,  503 => 244,  499 => 242,  497 => 241,  489 => 236,  478 => 232,  472 => 230,  466 => 228,  463 => 227,  459 => 226,  454 => 224,  447 => 219,  445 => 218,  434 => 210,  420 => 199,  406 => 188,  392 => 177,  378 => 166,  364 => 155,  356 => 150,  352 => 149,  342 => 142,  335 => 138,  331 => 137,  327 => 136,  323 => 135,  319 => 134,  314 => 131,  311 => 119,  305 => 118,  301 => 116,  288 => 113,  277 => 112,  273 => 111,  269 => 110,  266 => 109,  263 => 108,  259 => 107,  252 => 103,  248 => 102,  245 => 101,  239 => 98,  236 => 97,  230 => 94,  226 => 93,  223 => 92,  221 => 91,  214 => 87,  210 => 86,  205 => 83,  196 => 77,  188 => 71,  185 => 70,  173 => 66,  169 => 64,  164 => 63,  161 => 62,  152 => 58,  148 => 56,  146 => 55,  137 => 49,  127 => 41,  124 => 40,  112 => 36,  108 => 34,  103 => 33,  101 => 32,  98 => 31,  89 => 27,  85 => 25,  83 => 24,  76 => 19,  73 => 18,  68 => 14,  57 => 12,  53 => 11,  44 => 4,  42 => 3,  37 => 1,);
    }
