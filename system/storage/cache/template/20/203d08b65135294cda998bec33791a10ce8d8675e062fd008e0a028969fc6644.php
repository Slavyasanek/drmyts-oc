...
class __TwigTemplate_f00c7813a1dafd213fea64d27df9b41c7ab6c3466d8c75f816bb72c05daa82a0 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<main>
    <div class=\"page-title border--end\">
        <div class=\"container page-title__container\">
            <h1 class=\"text--upp text--size_h2-mob text--size_h2-desk page-title__title m-0\">{{ text_my_account }}</h1>
            <div class=\"breadcrumbs text--color_gray page-title__breadcrumbs\">
                <div class=\"breadcrumbs__list flex-row\">
                    {% for breadcrumb in breadcrumbs %}
