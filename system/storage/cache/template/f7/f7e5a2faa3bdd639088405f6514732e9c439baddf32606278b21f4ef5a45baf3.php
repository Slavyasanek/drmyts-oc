...
class __TwigTemplate_a5386dbba547a628ef4b80eceb5485327dbe4ad508b731d45579e34e347661b8 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["store"]) {
            ...
            echo "\">";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["store"], "name", [], "any", false, false, false, 380), "js");
            echo "</option>';
\t";
        }
        $_parent = $context['_parent'];
...
\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["extension"]) {
            ...
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["extension"], "name", [], "any", false, false, false, 398), "js");
            echo "\">';
\t";
            // line 399
            if ( !twig_get_attribute($this->env, $this->source, $context["extension"], "module", [], "any", false, false, false, 399)) {
                // line 400
                echo "\thtml += '      <option value=\"";
                echo twig_get_attribute($this->env, $this->source, $context["extension"], "code", [], "any", false, false, false, 400);
                echo "\">";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["extension"], "name", [], "any", false, false, false, 400), "js");
                echo "</option>';
\t";
            } else {
                // line 402
                echo "\t";
                $context['_parent'] = $context;
                $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, $context["extension"], "module", [], "any", false, false, false, 402));
                foreach ($context['_seq'] as $context["_key"] => $context["module"]) {
                    // line 403
                    echo "\thtml += '      <option value=\"";
                    echo twig_get_attribute($this->env, $this->source, $context["module"], "code", [], "any", false, false, false, 403);
                    echo "\">";
                    echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["module"], "name", [], "any", false, false, false, 403), "js");
                    echo "</option>';
\t";
                }
                $_parent = $context['_parent'];
