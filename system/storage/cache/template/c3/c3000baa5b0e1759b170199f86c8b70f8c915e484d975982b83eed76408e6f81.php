...
class __TwigTemplate_5d21cd38d2f5824d8f640b279a68e9f806cd5410e53e8ea3efe1447e8f8a7ac2 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t<div class=\"product-page__variants product-variants flex-col\">
    ...
    \t\t\t\t\t<p class=\"product-variants__title\">";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["option_value"]) {
                    ...
                    echo "\" id=\"size_15ml\">
        \t\t\t\t\t<label class=\"product-variants__label\" for=\"size_15ml\">";
                    // line 111
        ...
        \t\t\t\t\t</label>
                ...
                $context = array_intersect_key($context, $_parent) + $_parent;
                // line 114
                echo "    \t\t\t\t\t<input class=\"product-vairants__option anim\" type=\"radio\" name=\"size\" value=\"60 мл\" checked id=\"size_60ml\">
...
\t\t\t\t\t";
        // line 141
        echo twig_call_macro($macros["macros"], "macro_svg", ["add-to-cart", ""], 141, $context, $this->getSourceContext());
        echo "
...
\t\t\t\t\t";
        // line 145
        echo twig_call_macro($macros["macros"], "macro_svg", ["fast-buy", ""], 145, $context, $this->getSourceContext());
        echo "
...
\t\t\t\t\t";
        // line 153
        echo twig_call_macro($macros["macros"], "macro_svg", ["heart", ""], 153, $context, $this->getSourceContext());
        echo "
...
\t\t\t\t\t";
        // line 157
        echo twig_call_macro($macros["macros"], "macro_svg", ["need-help", ""], 157, $context, $this->getSourceContext());
        echo "
...
\t\t\t<div class=\"product-page__variants product-variants flex-col\">
    ...
    \t\t\t\t\t<p class=\"product-variants__title\">{{ option.name }}</p>
        ...
        \t\t\t\t\t<input class=\"product-vairants__option anim\" type=\"radio\" name=\"option[{{ option.product_option_id }}]\" value=\"{{ option_value.product_option_value_id }}\" id=\"size_15ml\">
        \t\t\t\t\t<label class=\"product-variants__label\" for=\"size_15ml\">{{ option_value.name }}
        \t\t\t\t\t</label>
                        {% endfor %}
