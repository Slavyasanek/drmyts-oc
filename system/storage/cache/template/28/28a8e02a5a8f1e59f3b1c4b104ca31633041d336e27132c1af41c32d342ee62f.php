...
class __TwigTemplate_26b596597df156ab34abb90b4a08738a227a5f1faefe9ff5c821113cde484a12 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t";
        // line 138
        echo twig_call_macro($macros["macros"], "macro_svg", ["add-to-cart", ""], 138, $context, $this->getSourceContext());
        echo "
\t\t\t\t\t<span>";
        // line 139
...
\t\t\t\t\t";
        // line 143
        echo twig_call_macro($macros["macros"], "macro_svg", ["fast-buy", ""], 143, $context, $this->getSourceContext());
        echo "
...
\t\t\t\t\t";
        // line 151
        echo twig_call_macro($macros["macros"], "macro_svg", ["heart", ""], 151, $context, $this->getSourceContext());
        echo "
...
\t\t\t\t\t";
        // line 156
        echo twig_call_macro($macros["macros"], "macro_svg", ["need-help", ""], 156, $context, $this->getSourceContext());
        echo "
...
\t\t\t\t\t\t<div class=\"icon icon--arrow accordion__icon\">
                            ";
        // line 167
        echo twig_call_macro($macros["macros"], "macro_svg", ["arrow-down", ""], 167, $context, $this->getSourceContext());
        echo "
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t";
        // line 178
        echo twig_call_macro($macros["macros"], "macro_svg", ["arrow-down", ""], 178, $context, $this->getSourceContext());
        echo "
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
\t\t\t\t\t<div class=\"accordion__content\">
...
\t\t\t\t\t\t\t";
        // line 189
        echo twig_call_macro($macros["macros"], "macro_svg", ["arrow-down", ""], 189, $context, $this->getSourceContext());
        echo "
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
\t\t\t\t\t<div class=\"accordion__content\">
...
\t\t\t\t\t\t\t";
        // line 200
        echo twig_call_macro($macros["macros"], "macro_svg", ["arrow-down", ""], 200, $context, $this->getSourceContext());
        echo "
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
\t\t\t\t\t<div class=\"accordion__content\">
...
\t\t\t\t\t\t\t";
        // line 211
        echo twig_call_macro($macros["macros"], "macro_svg", ["arrow-down", ""], 211, $context, $this->getSourceContext());
        echo "
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
\t\t\t\t\t<div class=\"accordion__content\">
...
\t\t\t\t\t\t\t<div class=\"product-rating product-page__rating flex-row\">
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
                ...
                if ((($context["rating"] ?? null) < $context["i"])) {
                    // line 229
                    echo "                                        ";
                    echo twig_call_macro($macros["macros"], "macro_svg", ["empty-star", "product-rating__star--empty"], 229, $context, $this->getSourceContext());
                    echo "
                                    ";
                } else {
                    // line 231
                    echo "                                        ";
                    echo twig_call_macro($macros["macros"], "macro_svg", ["full-star", "product-rating__star"], 231, $context, $this->getSourceContext());
                    echo "
                                    ";
                }
                // line 233
...
\t\t\t\t\t\t\t";
            // line 237
            echo twig_call_macro($macros["macros"], "macro_svg", ["arrow-down", ""], 237, $context, $this->getSourceContext());
            echo "
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t<button class=\"btn btn--theme btn--size_M btn--theme_accent text--upp flex-row product-page__icon-title product-reviews__btn j-center\" type=\"button\">
                                ";
                // line 245
                echo twig_call_macro($macros["macros"], "macro_svg", ["leave-review", ""], 245, $context, $this->getSourceContext());
                echo "
\t\t\t\t\t\t\t\t<span>";
                // line 246
...
\t\t\t\t\t\t\t\t\t\t<input type=\"hidden\" name=\"rating\" id=\"review-rating\" required>
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
                    // line 254
                    echo "                                            ";
                    echo twig_call_macro($macros["macros"], "macro_ratingStar", [$context["i"]], 254, $context, $this->getSourceContext());
                    echo "
                                        ";
                }
                $_parent = $context['_parent'];
...
\t\t\t\t\t\t\t\t\t\t<button class=\"btn btn--theme btn--theme_dark text--upp btn--size_M flex-row photo-upload__btn\" type=\"button\">
                                            ";
                // line 275
                echo twig_call_macro($macros["macros"], "macro_svg", ["plus", ""], 275, $context, $this->getSourceContext());
                echo "
\t\t\t\t\t\t\t\t\t\t\t<span>";
                // line 276
...
\t\t\t\t\t<div class=\"product-page__icon-title quote-block__title flex-row\">
                        ";
        // line 301
        echo twig_call_macro($macros["macros"], "macro_svg", ["warning", ""], 301, $context, $this->getSourceContext());
        echo "
...
\t\t\t\t<div class=\"quote-block__content d-flex\">
                    ";
        // line 308
        echo twig_call_macro($macros["macros"], "macro_svg", ["quote", "quote-block__icon"], 308, $context, $this->getSourceContext());
        echo "
...
";
    ...
    {
        return array (  835 => 499,  794 => 461,  787 => 457,  647 => 320,  632 => 308,  622 => 301,  615 => 296,  610 => 293,  604 => 291,  594 => 284,  588 => 283,  581 => 279,  575 => 276,  571 => 275,  563 => 270,  557 => 267,  547 => 264,  540 => 260,  534 => 256,  525 => 254,  521 => 253,  515 => 250,  508 => 246,  504 => 245,  500 => 243,  498 => 242,  490 => 237,  479 => 233,  473 => 231,  467 => 229,  464 => 228,  460 => 227,  455 => 225,  448 => 220,  446 => 219,  435 => 211,  421 => 200,  407 => 189,  393 => 178,  379 => 167,  365 => 156,  357 => 151,  353 => 150,  343 => 143,  336 => 139,  332 => 138,  328 => 137,  323 => 135,  319 => 134,  314 => 131,  311 => 119,  305 => 118,  301 => 116,  288 => 113,  277 => 112,  273 => 111,  269 => 110,  266 => 109,  263 => 108,  259 => 107,  252 => 103,  248 => 102,  245 => 101,  239 => 98,  236 => 97,  230 => 94,  226 => 93,  223 => 92,  221 => 91,  214 => 87,  210 => 86,  205 => 83,  196 => 77,  188 => 71,  185 => 70,  173 => 66,  169 => 64,  164 => 63,  161 => 62,  152 => 58,  148 => 56,  146 => 55,  137 => 49,  127 => 41,  124 => 40,  112 => 36,  108 => 34,  103 => 33,  101 => 32,  98 => 31,  89 => 27,  85 => 25,  83 => 24,  76 => 19,  73 => 18,  68 => 14,  57 => 12,  53 => 11,  44 => 4,  42 => 3,  37 => 1,);
    }
