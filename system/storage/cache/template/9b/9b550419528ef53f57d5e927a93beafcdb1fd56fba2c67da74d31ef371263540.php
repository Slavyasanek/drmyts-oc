...
class __TwigTemplate_d29f8621d0b5d30864fa0fe5a38c3a9ac085af0e73b7c2489742e54c4f786197 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<main>
    ...
    <section class=\"sign-form\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["customer_group"]) {
            // line 329
            echo "                      ";
            if ((twig_get_attribute($this->env, $this->source, $context["customer_group"], "customer_group_id", [], "any", false, false, false, 329) == ($context["customer_group_id"] ?? null))) {
                // line 330
                echo "
                ...
                echo "</label>
                      ...
                      <div class=\"radio\">
                        <label>
                          <input type=\"radio\" name=\"customer_group_id\" value=\"";
                // line 340
                echo twig_get_attribute($this->env, $this->source, $context["customer_group"], "customer_group_id", [], "any", false, false, false, 340);
                echo "\" checked=\"checked\" />
                          ";
                // line 341
                echo twig_get_attribute($this->env, $this->source, $context["customer_group"], "name", [], "any", false, false, false, 341);
                echo "</label>
                      </div>
        ...
        echo "\" id=\"input-password\" />
                        <button class=\"btn flex-center custom-input__icon abs\" type=\"button\">
                            ";
        // line 379
        echo twig_call_macro($macros["macros"], "macro_svg", ["eye", "anim"], 379, $context, $this->getSourceContext());
        echo "
                        </button>
                        ";
        // line 381
        ...
        echo "\" id=\"input-confirm\" />
                        <button class=\"btn flex-center custom-input__icon abs\" type=\"button\">
                            ";
        // line 388
        echo twig_call_macro($macros["macros"], "macro_svg", ["eye", "anim"], 388, $context, $this->getSourceContext());
        echo "
                        </button>
                        ";
        // line 390
                ...
                <div class=\"form-group required\" style=\"display: {% if customer_groups|length > 1 %} block {% else %} none {% endif %};\">
                    ...
                    <div class=\"col-sm-10\">{% for customer_group in customer_groups %}
                      {% if customer_group.customer_group_id == customer_group_id %}
                        ...
                        <div class=\"custom-radio sign-form__radio flex-row\"> 
                            <div class=\"custom-radio__wrapper rel\"> 
                                <input class=\"abs wh-full inset m-0\" type=\"radio\" name=\"customer_group_id\" value=\"{{ customer_group.customer_group_id }}\" checked=\"checked\">
                            </div>
                            <label for=\"np_department\">{{ customer_group.name }}</label>
                        </div>
