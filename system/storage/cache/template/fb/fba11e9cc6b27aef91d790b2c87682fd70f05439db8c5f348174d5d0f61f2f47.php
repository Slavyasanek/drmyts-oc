...
class __TwigTemplate_f66322d70b23c33c5cc18fc4a54995d2bc2e55a66bde1e8c0c875319fe47697c extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t\t<input type=\"hidden\" name=\"rating\" id=\"review-rating\" required>
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
                // line 251
                echo "                                                ";
                echo twig_call_macro($macros["macros"], "macro_ratingStar", [$context["i"]], 251, $context, $this->getSourceContext());
                echo "
                                            ";
            }
            $_parent = $context['_parent'];
...
\t\t\t\t\t\t\t\t\t\t\t<button class=\"btn btn--theme btn--theme_dark text--upp btn--size_M flex-row photo-upload__btn\" type=\"button\">
                                                ";
            // line 272
            echo twig_call_macro($macros["macros"], "macro_svg", ["plus", ""], 272, $context, $this->getSourceContext());
            echo "
\t\t\t\t\t\t\t\t\t\t\t\t<span>";
            // line 273
...
\t\t\t\t\t\t<div class=\"product-page__icon-title quote-block__title flex-row\">
                            ";
        // line 294
        echo twig_call_macro($macros["macros"], "macro_svg", ["warning", ""], 294, $context, $this->getSourceContext());
        echo "
...
\t\t\t\t\t<div class=\"quote-block__content d-flex\">
                        ";
        // line 301
        echo twig_call_macro($macros["macros"], "macro_svg", ["quote", "quote-block__icon"], 301, $context, $this->getSourceContext());
        echo "
...
<template id=\"photoUploadTemplate\">
    <div class=\"photo-upload__file rel o-hid\">
        ...
        <button class=\"photo-upload__delete btn flex-center icon abs\" type=\"button\">
            ";
        // line 314
        echo twig_call_macro($macros["macros"], "macro_svg", ["close", ""], 314, $context, $this->getSourceContext());
        echo "
        </button>
    </div>
</template>
