	...
	public function index() {
		...
		foreach ($results as $result) {
                ...
                if (isset($result['image']) && $result['image']) {
                    ...
                    $image = $this->model_tool_image->resize($result['image'], 116, 116);
                } else {
                    $image = $this->model_tool_image->resize('placeholder.png', 116, 116);
                }
                ...
                if (!empty($filter)) {
                    ...
                    foreach ($filter_ids as $filter_id) {
                        ...
                        if ($query->row) {
                            ...
                            $data['active_filters'][] = array(
                                'name'        => $query->row['name'],
                                'remove_href' => $this->url->link('product/manufacturer/info', 'manufacturer_id=' . $this->request->get['manufacturer_id'] . $url)
                            );
                        }
                    }
                }
