	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            ...
            if (isset($this->request->post['remember'])) {
                ...
                $expires = date('Y-m-d H:i:s', time() + 60 * 60 * 24 * 30); // 30 днів

                // BEFORE ADD NEW, DELETE OLD TOKENS
                $this->db->query("DELETE FROM " . DB_PREFIX . "customer_remember WHERE customer_id = '" . (int)$this->customer->getId() . "'");
